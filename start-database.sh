...
DB_CONTAINER_NAME="to-do-app-mysql"
...
# Extraer la contraseña de DATABASE_URL
DB_PASSWORD=$(echo "$DATABASE_URL" | awk -F':' '{print $3}' | awk -F'@' '{print $1}')

# Verificar y establecer una contraseña aleatoria si es la predeterminada
